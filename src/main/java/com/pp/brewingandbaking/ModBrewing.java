...
public final class ModBrewing {
    ...
    public static void onRegisterBrewingRecipes(RegisterBrewingRecipesEvent event) {
        ...
        builder.addRecipe(new CoffeeBrewingRecipe());

        // Strip the vanilla container conversions so a coffee potion cannot be turned
        // into splash/lingering/tipped variants, then re-add them for non-coffee potions.
    ...
    public static ItemStack makeCoffeeStackOf(Item base) {
        ...
        PotionContents contents = new PotionContents(
                Optional.<Holder<Potion>>of(ModPotions.COFFEE),
    ...
    private static final class NoCoffeeContainerConversionsRecipe implements IBrewingRecipe {
        ...
        public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
            ...
            // Block coffee from being converted into any thrown variant.
